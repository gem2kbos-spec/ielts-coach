const QUESTION_TYPE_GUIDE = {
  true_false_ng: 'True/False/Not Given statements',
  multiple_choice: 'Multiple choice (one correct answer from 4 options, label options A/B/C/D)',
  short_answer: 'Short answer (answer is 1-3 words copied/inferred directly from the passage)',
  sentence_completion: 'Sentence completion (a sentence with one blank, answer is 1-3 words from the passage)',
  summary_completion: 'Summary completion (each question is ONE numbered blank within a short summary of part of the passage; the prompt field should contain that blank in context, e.g. "...the report concluded that the main factor was ___.")',
  ...
  table_completion: 'Note/table completion, simplified as one blank per question (prompt describes the field being completed, e.g. "Year established: ___", answer is 1-3 words from the passage)',
};
